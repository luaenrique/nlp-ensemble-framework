...
Experimental setup:
  ...
  - Window positions : indices in the comdrift stream
"""
...
MMD_THRESHOLD = 0.2   # MMD score above which LoRA is retrained on the current window
...
ENCODERS = [
    {
        ...
        "out_path"          : "exp_06_drift_modernbert_ss.png",
    },
    {
        "name"              : "Jina-v2",
        ...
        "out_path"          : "exp_06drift_jina_ss.png",
    },
]
...
for enc in ENCODERS:
    ...
    for i in range(n_windows):
        ...
        # ── Detect-then-adapt: retrain LoRA when MMD exceeds threshold ─────────
        if score > MMD_THRESHOLD:
            ...
            print(f"  [ADAPT] Done — new reference set, gamma re-estimated.")
